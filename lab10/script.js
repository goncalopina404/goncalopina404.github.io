...
function ordenarProdutos(ordenacao) {
  ...
  if (ordenacao === 'crescente') {
      produtosOrdenados = todosProdutos.slice().sort((a, b) => a.price - b.price);
  } else if (ordenacao === 'decrescente') {
      produtosOrdenados = todosProdutos.slice().sort((a, b) => b.price - a.price);
  }
...
function finalizarCompra() {
    ...
    // Calcula o preço total com base no carrinho e se o usuário é estudante ou se há um desconto aplicado
    ...
    // Monta o objeto de envio para a API
    const requestData = {
